  ...
  const cheatDefs = [
    {
      ...
      plans: [
        { label: "Monthly", durationDays: 30, price: "35.00" },
        { label: "Lifetime", durationDays: null, price: "150.00" },
      ],
      gameId: isle.id,
    },
    {
  ...
  const utilityDefs = [
    {
      ...
      plans: [{ label: "Lifetime", durationDays: null as number | null, price: "150.00" }],
    },
    {
      slug: "skin-changer",
      name: "Skin Changer",
      description: "Unlock all cosmetics instantly.",
      plans: [{ label: "Lifetime", durationDays: null, price: "150.00" }],
    },
    {
      slug: "cloud-dma",
      name: "Cloud DMA",
